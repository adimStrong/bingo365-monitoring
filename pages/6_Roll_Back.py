"""
Channel ROI - Roll Back (Google Only)
Shows Google Roll Back performance data
"""
...
def main():
    ...
    st.markdown("Google Roll Back Performance Data")
    ...
    if google_df.empty:
        st.warning("⚠️ No Google Roll Back data available.")
        return

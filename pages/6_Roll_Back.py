...
def main():
    ...
    if show_fb:
        ...
        fb_weekly = fb_w.groupby('week_label').agg({'cost': 'sum', 'ftd': 'sum', 'register': 'sum'}).reset_index()
    ...
    if show_google:
        ...
        g_weekly = g_w.groupby('week_label').agg({'cost': 'sum', 'ftd': 'sum', 'register': 'sum'}).reset_index()
